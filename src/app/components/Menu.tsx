...
const Menu = () => {
    ...
    return (
        <div>
            ...
            {open && (<div className='bg-blue-800 text-white absolute left-0 top-24 w-full h-[calc(100vh-6rem)] flex flex-col gap-8 items-center justify-center text-3xl z-10'>
